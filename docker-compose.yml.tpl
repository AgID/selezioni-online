jconon:
  ...
  - ./webapp_logs:/logs
  - /tmp
  command: java -Xmx256m -Xss512k --spring.profiles.active=prod,agid -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8787 -Djava.security.egd=file:/dev/./urandom -jar /opt/selezioni-agid.war
  labels:
